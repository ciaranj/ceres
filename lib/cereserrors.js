...
var SliceDeleted = function (msg) {
  SliceDeleted.super_.call(this, msg, this.constructor);
};
util.inherits(SliceDeleted, AbstractError);
SliceDeleted.prototype.message = 'Slice Deleted';
module.exports.SliceDeleted= SliceDeleted;

var SliceGapTooLarge = function (msg) {
  SliceGapTooLarge.super_.call(this, msg, this.constructor);
};
util.inherits(SliceGapTooLarge, AbstractError);
SliceGapTooLarge.prototype.message = 'For internal use only';
module.exports.SliceGapTooLarge= SliceGapTooLarge;
