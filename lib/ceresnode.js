    ...
    function slicesAllRead() {
      ...
      if( earliestData ) {
        ...
        if( biggest_slice_timeStep != expected_retention_timeStep ) {
          ...
          // Ughhh this will be 'glitchy' around the boundary of the padding, but I'm way too
          // tired to sort it properly right now, hopefully a nice PR will turn up ;)
        ...
        var missing= Math.floor( (earliestData - fromTime) / ts );
